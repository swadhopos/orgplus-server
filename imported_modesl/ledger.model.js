...
const ledgerSchema = new mongoose.Schema({
  ...
  name: {
    ...
    // e.g. "General Fund 2024-25", "Masjid Construction Fund"
  },
  description: {
    type: String,
    trim: true,
...
// An org can have many ledgers, but names should be unique per org
ledgerSchema.index({ organizationId: 1, name: 1 }, { unique: true, partialFilterExpression: { 'audit.isDeleted': false } });
